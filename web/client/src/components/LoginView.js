        ...
        <div className="max-w-md mx-auto space-y-5 pt-2 px-2 relative z-10">
            ...
            {loginView === 'menu' && !gameId && (
                <div className="space-y-4 animate-fade-in">
                    ...
                    {/* Google Login / Guest Profile Status */}
                    <div className="glass-card p-4 flex items-center justify-between border border-emerald-500/20 bg-slate-800/40">
                        <div className="flex items-center gap-3">
                            {user?.photoUrl ? (
                                <img src={user.photoUrl} alt="Avatar" className="w-10 h-10 rounded-full border border-emerald-500/50" />
                            ) : (
